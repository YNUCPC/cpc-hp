# cpc-hp [![Build Status](https://app.travis-ci.com/YNUCPC/cpc-hp.svg?branch=master)](https://app.travis-ci.com/YNUCPC/cpc-hp)
...
1. https://github.com/YNUCPC のメンバーに入っていない場合、メンバーに頼んで招待を送ってもらう。
